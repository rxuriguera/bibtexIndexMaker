...
JabRef, si és possible també podria ser interessant utilitzar Jython (per motius de consistència).
\\
\\
El toolkit NLTK pot ser bastant útil a l'hora de tractar els textos amb Python. Actualment hi ha alguns problemes per 
