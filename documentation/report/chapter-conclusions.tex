...
\paragraph{}
En part, podríem dir que procés d'extracció s'ha basat en un cúmul d'assumpcions que, dins del context de l'aplicació, es compleixen en la majoria de casos. De totes maneres, cal tenir en compte que el procés es veu afectat per pèrdues que són inevitables a cada pas:
\begin{itemize}
\item{}
