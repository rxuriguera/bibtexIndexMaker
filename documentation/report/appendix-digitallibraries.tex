...
Al llarg d'aquest document hem definit què són les biblioteques digitals i també n'hem anat esmentant algunes de les que hi ha disponibles a Internet. En aquest apèndix només intentem llistar i facilitar enllaços a totes les que s'han utilitzat a l'hora de realitzar les proves. També hem inclòs petites introduccions extretes de les descripcions escrites per ells mateixos:
