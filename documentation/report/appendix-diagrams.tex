...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/diagrams:references-domain-model.pdf}
\caption{Model de domini respecte a referències}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/diagrams:wrappers-domain-model.pdf}
