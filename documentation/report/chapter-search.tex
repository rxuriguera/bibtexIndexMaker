...
\paragraph{}
Una altra situació en que no serem capaços d'extreure el text del PDF és quan el text ha estat escanejat i els fitxers PDF només contenen imatges. Pel que hem vist, això sol passar sobretot per articles de fa uns quants anys. Com és lògic, aquest tipus de fitxers no es tractaran en aquest projecte.
