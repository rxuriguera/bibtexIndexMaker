...
\paragraph{}
El problema, és que normalment les entrades no es troben a la mateixa pàgina retornada pels cercadors, sinó que cal seguir algun enllaç. A més, hi ha moltes biblioteques digitals que no ofereixen les referències en \BibTeX{} sinó en altres formats com ara \textit{RIS}, \textit{MODS}, etc. Els formats que s'ofereixen depenen força del camp de coneixement en què s'especialitza la biblioteca.
