...
En el nostre cas farem servir aquest llenguatge com a format d'entrada de referències a l'importar-les i també com a format de sortida al generar els índexs bibliogràfics. Al llistat \ref{listing:exampleBibTeX} es mostra un exemple d'una referència d'un article científic expressat en el format \BibTeX:
\begin{center}
