...
\tab \textit{Browser} per obtenir consultes                                \\
\tab Cerca de les consultes (múltiples cercadors)                          \\
\tab Ordenar resultats de la cerca                                         \\
\hline


Extracció d'informació (\texttt{bibim.ie})                                 \\
\tab \textit{Wrappers} a mà                                                \\
\tab Generació automàtica de \textit{wrappers}                             \\
\tab \tab Extracció d'exemples                                             \\
\tab \tab Generació de regles                                              \\
\tab \tab \textit{Wrapper} genèric                                         \\
\hline
