...
Així doncs, hem de fer una mica més de tomb per poder aconseguir els resultats desitjats, però els passos són més senzills d'aplicar. El problema que teníem al principi l'hem dividit en tres problemes més petits:
\begin{itemize}
\item{}
