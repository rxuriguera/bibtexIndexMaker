...
\textit{\BibTeX{} Bibliography Index Maker} és una eina d'ajuda a la creació d'índexos bibliogràfics pensada com un complement a aplicacions de maneig de referències ja existents com poden ser \textit{\href{http://jabref.sourceforge.net/}{JabRef}}\footnote{http://jabref.sourceforge.net/} o \textit{\href{http://www.mendeley.com/}{Mendeley}}\footnote{http://www.mendeley.com/}.
